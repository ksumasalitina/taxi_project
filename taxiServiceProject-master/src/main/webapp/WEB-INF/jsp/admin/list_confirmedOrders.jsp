...
<table id="main-container">
    ...
    <tr>
        <td class="content">
            <h1>All orders</h1>
                <a id="admin-a" href="controller?command=listOrders">
                    Source table
                </a><br>
                <a id="admin-a" href="controller?command=listSortedByDateOrdersDESC">
                    Sort orders by date (DESC)
                </a><br>
                <a id="admin-a" href="controller?command=listSortedByDateOrdersASC">
                    Sort orders by date (ASC)
                </a><br>
                <a id="admin-a" href="controller?command=listSortedByCostOrders">
            ...
            <a id="admin-a" href="controller?command=listCategories">
                Sort orders by date (ASC)
            </a><br>
