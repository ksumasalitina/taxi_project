...
public class ListSortedOrdersByDateCommandDESC extends Command {
    ...
    public String execute(HttpServletRequest request,
        ...
        List<ConfirmedOrderBean> confirmedOrderBeanList = new ClientOrderDao().sortConfirmedOrderBeansByDateDESC();
