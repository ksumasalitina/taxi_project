...
public class ListSortedOrdersByDateCommandASC extends Command{
    private static final long serialVersionUID = -526656047860176058L;

    private static final Logger log = Logger.getLogger(ListSortedOrdersByDateCommandDESC.class);
    ...
    public String execute(HttpServletRequest request,
        ...
        List<ConfirmedOrderBean> confirmedOrderBeanList = new ClientOrderDao().sortConfirmedOrderBeansByDateASC();
